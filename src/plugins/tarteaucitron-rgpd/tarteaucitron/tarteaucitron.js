                    ...
                    if (document.getElementById('tarteaucitronAlertBig') !== null && !tarteaucitron.highPrivacy) {
                        if (document.getElementById('tarteaucitronAlertBig').style.display === 'block') {
                            ...
                            if (scrollPos > (screen.height * 2)) {
                                ...
                                document.getElementById('tarteaucitronDisclaimerAlert').innerHTML = '<strong>' + tarteaucitron.lang.alertBigScroll + '</strong> ' + tarteaucitron.lang.alertBig + ' <a href="' + tarteaucitron.parameters.privacyUrl +'">' + tarteaucitron.lang.privacyUrl + '</a>' + ', <a href="#" onclick="tarteaucitron.userInterface.openPanel(); return false;">' + tarteaucitron.lang.personalize + '</a>';
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.parameters.highPrivacy && !tarteaucitron.parameters.AcceptAllCta) {
                    ...
                    html += ', <a href="#" onclick="tarteaucitron.userInterface.openPanel(); return false;">' + tarteaucitron.lang.personalize + '</a>';
                    html += '   </span>';
